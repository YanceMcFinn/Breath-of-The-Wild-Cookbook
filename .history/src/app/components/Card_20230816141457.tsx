export function Card(props){
    return(
        <div className="card-bg aspect-auto !px-0 pt-0 border-solid border-sheikah-slate-blue border-2 block rounded-md inline-block space-y-1 space-x-1 p-2 text-center">
