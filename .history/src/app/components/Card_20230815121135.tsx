export function Card(props){
    return(
        <div className="card-bg aspect-auto border-solid border-zelda-green border-2 rounded-md block text-center justify-center items-center space-y-1 space-x-1 p-2">
