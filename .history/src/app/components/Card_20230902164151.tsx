...
export function Card(props: { imgUrl: string, name: string, effect: string, description: string }){
    return(
        <div className="card-bg aspect-auto !px-0 pt-0 border-solid border-sheikah-slate-blue text-sheikah-slate-blue glow border-2 block rounded-md inline-block space-x-1 p-2 text-center">
            ...
            <div className="px-2">
                ...
                <div className="!flex !flex-1 !flex-col !justify-between text-left h-100">
                    ...
                    <div className="border-y-2 border-indigo-500 !self-end">
