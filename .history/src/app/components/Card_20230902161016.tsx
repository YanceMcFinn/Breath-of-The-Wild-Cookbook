        ...
        <div className="card-bg aspect-auto !px-0 pt-0 border-solid border-sheikah-slate-blue text-sheikah-slate-blue glow border-2 block rounded-md inline-block space-y-1 space-x-1 p-2 text-center">
            ...
            <div className="px-2">
                ...
                <div className="text-left h-100">
                    ...
                    <a href={`/materials/${props.name.replace(" ","_")}`}><button className="bg-sheikah-slate-blue hover:bg-blue-700 text-white font-bold py-2 px-4 my-2 rounded">Info</button></a>
                </div>
            </div>
        </div>
    )
