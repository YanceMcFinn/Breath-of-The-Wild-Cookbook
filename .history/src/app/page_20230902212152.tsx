...
export default function Home() {
  ...
  async function loadMaterials() {
    const response = await fetch(`https://botw-compendium.herokuapp.com/api/v3/compendium/category/materials?game=${gameMode}`);
...
useEffect(()=>{
  ...
  if(item.common_locations != null){
    for (var location of item.common_locations){
...
locations.push(gameMode)
console.log(locations)},[gameMode])
