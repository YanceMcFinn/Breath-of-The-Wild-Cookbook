    ...
    <main>
      <div className='text-center'>
        ...
        <div className='my-3 mx-2 text-center w-full'>
          <p className='hyliaFont text-xl text-sheikah-slate-blue glow inline-block mr-2'>Search </p><input className='rounded w-1/2 bg-transparent	border-sheikah-slate-blue-200' type='text'></input>
        </div>
      </div>
      <div className='px-5'>
