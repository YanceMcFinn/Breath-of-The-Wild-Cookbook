  ...
  return (
    <main>
      ...
      <div className="inline-flex card-bg rounded-md shadow-sm" role="group">
        ...
        <button type="button" onClick={()=>setGameMode('totk')} className="px-4 py-2 text-sm font-medium text-gray-900 border-t border-b border-r border-sheikah-slate-blue rounded-r-lg">
          Settings
        </button>
      </div>
