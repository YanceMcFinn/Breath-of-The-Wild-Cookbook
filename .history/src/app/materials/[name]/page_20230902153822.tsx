...
export async function generateStaticParams() {
  ...
  export default async function Material ({ params }){
    ...
    return (
      <div className="card-bg m-3 w-100 grid grid-cols-2 px-0 pt-0 border-solid border-sheikah-slate-blue text-sheikah-slate-blue glow border-2 block rounded-md inline-block space-y-1 space-x-1 p-2">
        <div id='left-col' className="w-30">
          <img className='w-100 object-cover p-0' src={material.image}></img>
        </div>
