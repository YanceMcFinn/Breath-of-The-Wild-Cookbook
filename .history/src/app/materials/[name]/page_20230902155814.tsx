...
export async function generateStaticParams() {
  ...
  export default async function Material ({ params }){
    ...
    return (
      <div className="prose-xl card-bg m-3 w-100 h-50 grid grid-cols-2 px-0 py-0 border-solid border-sheikah-slate-blue text-sheikah-slate-blue glow border-2 block rounded-md inline-block space-y-1 space-x-1 p-2">
